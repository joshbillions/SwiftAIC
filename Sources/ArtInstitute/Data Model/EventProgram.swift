...
public struct EventProgram: Codable {
    ...
    public let isAffiliateGroup: Bool?

    /** Whether this program represents an event host */
    public let isEventHost: Bool?
    ...
    public enum CodingKeys: String, CodingKey { 
        ...
        case title
        case isAffiliateGroup = "is_affiliate_group"
        case isEventHost = "is_event_host"
