...
public struct Selection: Codable {
    ...
    /** Whether the location is published on the website */
    public let published: Bool?

    /** A brief summary of what is contained in the selection */
    public let shortCopy: String?

    /** The text of the selection description */
